"""add username nullable then set not null

Revision ID: 7bdd888fc710
Revises: 8902123113aa
Create Date: 2025-07-04 01:35:32.979500
...
revision = '7bdd888fc710'
down_revision = '8902123113aa'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Note: game table is already created by fd370ea4c3a0 migration
    # Only create game table if it doesn't exist
